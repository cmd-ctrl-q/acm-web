  ...
  return (
    <div className="navacmbg">
      < Navbar className="navacm" collapseOnSelect expand="lg" bg="dark" fixed="top" variant="dark" >
        <Navbar.Brand className="acm" onClick={()=> history.push("/")}><img style={{ height: '50px', width: '50px', marginRight: '10px' }} src={acmlogo} />Association for Computing Machinery</Navbar.Brand>
